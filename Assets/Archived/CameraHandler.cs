...
/// 
/// </summary>
public class CameraHandler : MonoBehaviour, Unity.Cinemachine.IInputAxisOwner
{
    ...
    public InputAxis ForwardBackward = InputAxis.DefaultMomentary;
    ...
    void IInputAxisOwner.GetInputAxes(List<IInputAxisOwner.AxisDescriptor> axes)
    {
        ...
        axes.Add(new() { DrivenAxis = () => ref ForwardBackward, Name = "Move Z"});
    ...
    void Reset()
    {
        ...
        ForwardBackward = InputAxis.DefaultMomentary;
    ...
    void Update()
    {
        ...
        var movement = rot * new Vector3(Sideways.Value, UpDown.Value, ForwardBackward.Value);
